...
class OrderPageLocators:
    ...
    input_phone_number = [By.XPATH, ".//input[@placeholder='* Телефон: на него позвонит курьер']"]   # Поле ввода "Телефон"
    ...
    input_start_date = [By.XPATH, ".//input[@placeholder='* Когда привезти самокат']"]   # Поле ввода "Когда привезти самокат"
    input_rent_period = [By.XPATH, ".//div[@class='Dropdown-placeholder']"]   # Поле выбора "Срок аренды"
    dropdown_menu_rent_period = [By.XPATH, f".//div[@class='Dropdown-option'][{Data.rent_period}]"]   # # Первый пункт в выпадающем списке выбора срока аренды
    color_checkbox = [By.XPATH, f".//input[@id='{Data.color}']"]   # Чекбокс выбора цвета
